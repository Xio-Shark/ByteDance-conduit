...
| 成员 | 实际职责 | 对应仓库 / 证据 |
|------|----------|-----------------|
| 滕彦翕 | 团队成员；参与系统实现、材料整理与答辩准备 | `apps/`、`services/`、`sandbox-repo/`、`docs/reports/`、文档仓 `docs/01`–`13` |
| 李泽士 | 团队成员；参与系统实现、材料整理与答辩准备 | `apps/`、`services/`、`sandbox-repo/`、`docs/reports/`、文档仓 `docs/01`–`13` |
| 王伯瀚 | 团队成员；参与系统实现、材料整理与答辩准备 | `apps/`、`services/`、`sandbox-repo/`、`docs/reports/`、文档仓 `docs/01`–`13` |

可参考模块边界：Orchestrator / Agent / Skill / Web / API / submission / 设计基线与验收追踪。实际填写时只保留真实发生的分工。
...
|------|------|------|
| 在线 Demo | 未提供 | 尚未部署 |
| 演示视频（3–8 分钟） | 未提供 | 尚未录制（脚本见 [`video-recording-guide.md`](./video-recording-guide.md)） |
